...
//     / __|   __ _     | |    | |_    | || |   | _ \   (_)    __ __    ___     | |    |   \    ___    __ __     ___
//     \__ \  / _` |    | |    |  _|    \_, |   |  _/   | |    \ \ /   / -_)    | |    | |) |  / -_)   \ V /    |_ /
//     |___/  \__,_|   _|_|_   _\__|   _|__/   _|_|_   _|_|_   /_\_\   \___|   _|_|_   |___/   \___|   _\_/_   _/__|
...
class Shop extends PluginBase
{
	...
	public function amountForm(Player $player, $cat, $result, $buydata): void
	{
		...
		if ($result === null) {
			...
			$form->addInput("Amount of $list[3]", $list[2], $list[2]);
			$form->sendToPlayer($player);
		}
